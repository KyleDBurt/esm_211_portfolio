...
ggsave(here("plots","bison_ts_density.jpg"),bison_ts, dpi=400, width=5,
       height=3, unit="in")
...
# model fit
model_arima <- auto.arima(ts_bison_density, ic="bic") 
...
plot(forecasted_values, main = "Population Density Forecast", 
