...
# survfit (fits a survival curve based on the survival object and the stratification)
# 
...
# at time = 500, 25% chance that sex 1 (male) will survive longer and ~45% chance that sex 2...
